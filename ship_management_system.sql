...
create table Passenger(
    ...
    FOREIGN KEY (State) REFERENCES State_Country(State),
...
create table Ship(
    ...
    PRIMARY KEY (Ship_ID),
    FOREIGN KEY (SourcePort_ID) REFERENCES Port(Port_ID),
    FOREIGN KEY (DestinationPort_ID) REFERENCES Port(Port_ID),
...
create table Ticket(
    ...
    FOREIGN KEY (DepartureTime, Ship_Id) REFERENCES Route(DepartureTime, Ship_ID),
    FOREIGN KEY (Port_Id) REFERENCES Port(Port_ID),
    FOREIGN KEY (Passenger_Id) REFERENCES Passenger(Passenger_ID),
    FOREIGN KEY (Agent_Id) REFERENCES BookingAgent(Agent_ID),
...
create table EmployeeDependent_PNo(
    ...
    PhoneNumber VARCHAR(20) NOT NULL,
    PRIMARY KEY (PhoneNumber),
    FOREIGN KEY (Employee_ID, DependentNo) REFERENCES Employee_Dependent(Employee_ID, DependentNo),
    CONSTRAINT PhoneNumber CHECK(PhoneNumber NOT LIKE '%[^0-9]%'),
    CONSTRAINT Employee_ID CHECK(LENGTH(CONVERT(Employee_ID, CHAR)) = 7)
);
